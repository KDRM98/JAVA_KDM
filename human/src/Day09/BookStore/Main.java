...
public class Main {
	...
	// 장바구니 목록, 장바구니에 담긴 개수
	static Cart[] cartList = new Cart[BOOK_COUNT + 1];
	 ...
	 * @param tel
	 */
	private static void guestInfo(Person person) {
	...
	public static void cartSetCount() {
		...
		Scanner sc = new Scanner(System.in);
		System.out.println("수량을 조절할 장바구니 번호 : ");
		int no = sc.nextInt();
	...
	public static void cartRemove() {
		System.out.println("********** 장바구니 항목 삭제 **********");
		System.out.println("삭제할 장바구니 항목의 ISBN : ");
		Scanner sc = new Scanner(System.in);
		String bookId = sc.nextLine();
	...
	/**
	 * 장바구니에 책이 들어있는지 확인 - 이미 담겨져 있으면, 수량을 1개 증가시키기 true를 반환 - 장바ㅈ구니에 없으면 false를 봔환
	 */
